...
public class DataT2 extends Data {
	...
	public DataT2(Folder folder) {
		...
		lede = "Producer Price Inflation (PPI) measures the price changes of goods bought and " + "sold by UK manufacturers this month compared to the same month a year ago. PPI provides a "
				...
				+ "PPI is split into two components: output price inflation and input price inflation. The " + "input price indices capture changes in the cost of the material and fuel inputs that "
				+ "producers face whereas the output price indices capture the changing prices of goods sold " + "by producers."
		...
		more = "Annual output and input price changes follow similar trends, but with the " + "latter tending to have higher price growth1. In Figure 1, trends in producer price "
