...
public class ChildT2 extends TaxonomyNode {
	...
	private void buildList1() {
		Detail detail;
		detail = new Detail("Gross Domestic Product", "£390383", "m",
				"1st Quarter 2014");
		this.detail.add(detail);
		detail = new Detail("GDP Quarter on Quarter Growth", "0.8", "%",
				"1st Quarter 2014");
		this.detail.add(detail);
		detail = new Detail("GDP Change on same Quarter a year ago", "0.3",
				"%", "1st Quarter 2014");
		this.detail.add(detail);
	...
	private void buildList2() {
		...
		this.detail.add(detail);
		detail = new Detail(
				"CPIH Annual Rate Percentage Change over 12 months", "1.8",
				"%", "January 2014");
		this.detail.add(detail);
	}
