 ...
 * How to create a methodology item for the Alpha website
...
Summary: Displayed in the boxes on other pages leading to the methodology
...
Use an H1 line to set the methodology title, e.g.:
