...
var onsControllers = angular.module('onsControllers', ['highcharts-ng', 'googlechart']);
...
onsControllers.controller('GoogleChartCtrl', ['$scope',
    function($scope) {
        $scope.getData("/googlechart.json", function(data) {
            $scope.chart = data;
        });
    }
]);
