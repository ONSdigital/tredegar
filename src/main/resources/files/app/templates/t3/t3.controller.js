(function() {
	...
	function T3ChartController($scope, $location, $log, Downloader, Taxonomy, Chart) {
        ...
        var dataPath = '/data' + $scope.taxonomy.data.headline
            ctrl.timeseries = $scope.taxonomy.data.headlineData
	...
	function T3RepeatItemController($scope, $location, $log, Downloader, Taxonomy, Chart) {
		console.log('T3RepeatItemController $scope.$index: ' + $scope.$index)
		console.log('T3RepeatItemController scopedTimeseries: ' + JSON.stringify($scope.taxonomy.data.items[$scope.$index]))
		console.log('T3RepeatItemController itemData: ' + JSON.stringify($scope.taxonomy.data.itemData[$scope.$index]))
		var scopedTimeseries = $scope.taxonomy.data.itemData[$scope.$index]
		console.log('T3RepeatItemController scopedTimeseries data: ' + JSON.stringify(scopedTimeseries))
        var ctrl = this
