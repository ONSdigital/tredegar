...
public class CollectionSearchResultTest {
	...
	public void testGetResults() {
		...
		assertEquals("url should be available from map", "/taxonomy/economy/inflationandpriceindices/bulletins/producerpriceinflation/2014q2/", bulletin.get("url"));
	...
	private List<File> setUpFiles(String fileName) {
		...
		if (StringUtils.isEmpty(fileName)) {
			file = new File("target/taxonomy/economy/inflationandpriceindices/bulletins/producerpriceinflation/2014q2/data.json");
		} else {
