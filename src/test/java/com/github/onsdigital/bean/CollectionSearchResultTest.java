...
public class CollectionSearchResultTest {
	...
	public void testGetResults() {
		...
		assertEquals("title should be available from map", "Cat Tail Inflation, October 2014", bulletin.get("title"));
		assertEquals("release date should be available from map", "19 February 2014", bulletin.get("releaseDate"));
		assertEquals("url should be available from map", "/taxonomy/economy/inflationandpriceindices/bulletins/consumerpriceinflationjune2014/", bulletin.get("url"));
